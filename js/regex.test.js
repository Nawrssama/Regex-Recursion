...
function ioEmail(email){
    // Add your logic.
     // Define the regular expression string for an email that ends with ".io"
     const string = /^[a-zA-Z0]+@[a-zA-Z0]+\.(io)$/;

     // Test the input email against the string
...
function imagesSearcher(text){
    let arr = [];
    // Add your logic.
     // Define the regular expression pattern for image names with the required extensions
    let pattern = /^[a-zA-Z0]+(.jpg|.jpeg|.png)$/g;
    

    // Find all matches in the input text using the regular expression
